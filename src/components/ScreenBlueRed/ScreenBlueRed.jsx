import {
  ...
  ScreenTablet,
  Latency,
} from './../ScreensOnlyRed/Screens.styled.js';
...
import {
  latencySouthAmericaBlueRed,
  latencyNorthAmericaBlueRed,
  latencyEuropeBlueRed,
  latencyAsiaBlueRed,
  latencyOceaniaBlueRed,
} from 'services/latencyBlueRed.js';
import { maxLatency } from 'services/maxLatencyOnlyRed.js';
import { useEffect, useState } from 'react';
import { toPause } from 'services/pause.js';

export const ScreensBlueRed = ({
  countMenUsa,
  countMenSouthAm,
  countMenEurope,
  countMenAsia,
  ...
  const { europaLarge, europaMedium, europaSmall } = latencyEuropeBlueRed(
    numberTwoServers,
    westUsa.west_usa_los_angeles,
    eastUsa.east_usa_new_york,
    germany.germany_frankfurt,
  ...
  const { asiaLarge, asiaMedium, asiaSmall } = latencyAsiaBlueRed(
    numberTwoServers,
    westUsa.west_usa_los_angeles,
    eastUsa.east_usa_new_york,
    germany.germany_frankfurt,
  ...
  const { oceaniaLarge, oceaniaMedium, oceaniaSmall } = latencyOceaniaBlueRed(
    numberTwoServers,
    westUsa.west_usa_los_angeles,
    eastUsa.east_usa_new_york,
    germany.germany_frankfurt,
